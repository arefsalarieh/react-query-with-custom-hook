...
import useInfiniteQueryGet from "../customHook/useInfiniteQueryGet";
...
const {data , fetchNextPage , hasNextPage , isFetching , isLoading , isError} = useInfiniteQueryGet(initialUrl)
